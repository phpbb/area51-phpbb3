...
class user extends session
{
	...
	*/
	function setup($lang_set = false, $style = false)
	{
		...
		if (false && !defined('DEBUG_EXTRA') && !defined('ADMIN_START') && !defined('IN_INSTALL') && !defined('IN_LOGIN') && file_exists($phpbb_root_path . 'install') && !is_file($phpbb_root_path . 'install'))
		{
